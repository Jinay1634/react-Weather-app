...
<p>{details} </p>
        ...
        <div className='flex flex-row items-cente justify-between text-white py-3'>
...
<span className='font-medium ml-1'>{`${speed.toFixed()}`} km/h</span>
 ...
 <div className='flex flex-row ic justify-center space-x-2 text-white text-sm py-3'>
    <UilSun/>
