...
function UserInputs({setQuery,units,setUnits}) {
...
<button name='metrics'  className='text-xl text-white font-light transition ease-out hover:scale-125 ' onClick={handleUnitsChange}>
°C
</button>
